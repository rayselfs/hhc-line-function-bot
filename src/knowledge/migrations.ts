...
const migrations = [
  ...
  `update knowledge_sources set
     staged_display_name=coalesce(staged_display_name,display_name),
     staged_adapter_type=coalesce(staged_adapter_type,adapter_type),
     staged_external_root_id=coalesce(staged_external_root_id,external_root_id),
     staged_root_url=coalesce(staged_root_url,root_url),
     staged_enabled=coalesce(staged_enabled,enabled),
     staged_expires_at=coalesce(staged_expires_at,expires_at),
